...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog( "Insert an adjective here!" );
		// Get the user to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Insert a liquid here!");
		// Get the user to enter a body part
		String bodypart = JOptionPane.showInputDialog("Insert a body part here!");
		// Get the user to enter a verb
		String verb = JOptionPane.showInputDialog("Insert a verb here!");
		// Get the user to enter a place
		String place = JOptionPane.showInputDialog("Insert any place in the universe here!");
