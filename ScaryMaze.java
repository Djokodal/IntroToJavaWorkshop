...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("swvader02.wav"));
		AudioClip sound2 = JApplet.newAudioClip(getClass().getResource("givein.wav"));
		AudioClip sound3 = JApplet.newAudioClip(getClass().getResource("ALL2EASY.wav"));
